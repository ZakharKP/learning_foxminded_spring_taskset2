...
public class TestDataPathStorage extends PathStorageImpl {
	/**
	 * Constructs a TestDataPathStorage object with the specified resource
	 * directory.
	 *
	 * @param resourceDir the path to the resource directory
	 */
	public TestDataPathStorage(Path resourseDir) {
		super(resourseDir);
