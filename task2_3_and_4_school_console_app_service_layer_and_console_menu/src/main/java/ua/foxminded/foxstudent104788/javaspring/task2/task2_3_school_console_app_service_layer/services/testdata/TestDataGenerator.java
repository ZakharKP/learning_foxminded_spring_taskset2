...
public class TestDataGenerator {
	...
	public List<CourseRoster> getCourseRosters() {
		...
		for (int i = 1; i <= 200; i++) {
			...
			addCoursesForThatStudent(i, courseRosters);

		}
		return courseRosters;
	}

	private void addCoursesForThatStudent(int studentId, List<CourseRoster> courseRosters) {
		...
		for (int i = 0; i < coursesForEach; i++) {
			...
			courseRosters.add(new CourseRoster(null, studentId, courseId));
		}
