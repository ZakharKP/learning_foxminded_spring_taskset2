package ua.foxminded.foxstudent104788.javaspring.task2.task2_3_school_console_app_service_layer.dao.helpers;
...
class QueryBuilderTest {
	...
	void testGetCountByQuery() {
		...
		String actual = queryBuilder.getGroupByCountQuery("first_name", "<=");
